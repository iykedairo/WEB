...
function fn(i, e, obj){
techie[i] = e; mixin(techie[i],pt.sapi);}}},
...
pt.DomReadyState = true;
}else{
pt.DomReadyState = false;}
return pt.DomReadyState;
}return pt.DomReadyState; },
...
stk = [], arr = pt.explode(all[0]),items = (pt.isArrayLike(all[1])) ? pt.explode(all[1]) : String([].slice.call(arguments,1)).split(',');
