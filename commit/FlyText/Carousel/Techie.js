    ...
    Techie.sapi = Techie.prototype = {
        ...
        Techie: function(selector, context) {
            ...
            if (typeof plain === 'object' && plain.functions(selector)) {
             ...
             context  = context ? ( typeof context === "string" ? Techie(context) : context)  : document;
       context = context.length ? context[0] : context.nodeType ? context : document;
            var nodes = [];
            if (isList(selector)) {
...
DefineAccessors(Techie.prototype, "CSS", function gettr(){return  function(object, option ){
        option = ( object && (object.nodeType || isCollection(object))) ? (option || "") : object; 
        object = option == object ? this : object;return styles(object, option); };}, styles);
...
DefineAccessors(Techie.prototype, "styles", function gettr(){return  function(object, option ){
        option = ( object && (object.nodeType || isCollection(object))) ? (option || "") : object; 
        object = option == object ? this : object;return styles(object, option); };}, styles);
...
if(!(isHTML(element) || isCollection(element)) || typeof style !== "string" || typeof(options) !== "string") { 
