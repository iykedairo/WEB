...
DefineAccessors(Techie.prototype, "CSS", function gttr(){
 ...
 function  styles ( element, style, options )    {
...
//ONE ARGUMENT SUPPLIED
 ...
 isHTML(element) ? style = style : style = element;
element = isHTML(element) ? element : isHTML(this) ? this :  null;
...
function styless (object, styleOptions) {
if(!object){ var html;
...
return this;
    ...
    function isNode(object) { /*HTML nodes are objects and no other data type;
        ...
        isNode(object);*/
        var un, i; if (typeof object !== 'object') { return false;}
        return checkHtml(object);
        function ChkNm(n) {
         if (isNodeList(n)) { n = n[0]; }
try { n = upper.call(n);} catch (e) { return false;}
            un = ['UNKNOWN', 'UNDEFINED', 'NULL', 'NAN', 'OBJECT OBJECT'];
    var r = true; forEach(function() {
                if (index(n, this) !== -1) {r = false;} }, un);
            return r;
        }
