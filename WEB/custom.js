...
today : : ({
		//only initialize here, no calling yet
		Date : new Date(),
		//Day : Date.getDay(),
		//Hour : Date.getHour(),
		DateDiv : document.createElement("p"),
		//DivPos : document.body.appendChild(DateDiv),
	 getNow : function(){
		 	//do all necessary calling here
		 	var DateDiv = this.DateDiv;
		  ...
		  var DivPos = document.body.insertBefore(DateDiv, this.firstChild);
		  var comfirm = confirm("Do you want date on this page? If NO, click cancel.");
			return (!comfirm === !false) ? null : this.DateDiv.innerHTML = this.Date; 
		}
}),//To call it right away, comment out this line and uncomment the line below;
	//}).getNow()
