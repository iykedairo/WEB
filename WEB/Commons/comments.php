...
// Initialize error array.
  ...
  else{ $errors[] = 'Sorry you entered an invalid firstName Id';}
  }
  ...
  else{ $errors[] = 'Sorry you entered an invalid lastName Id';}
  }
  ...
  else{ $errors[] = 'Sorry you entered an invalid comment Id';}
  }
  //End of validation
  //End of validation
...
// if (isset($_REQUEST['submitted'])) {
  ...
  $subject = "Admin of Michael Iyke Info Page! Comment from " . $firstName;
