...
Slice: Slice,
        ...
        extend: extend,
        isAbsent: isAbsent,
        isNumber: plain.numbers,
        isString: plain.strings,
        isUndefined: type.undefineds,
        isPrimitive: type.primitives,
        isArray: plain.arrays,
        isObject: plain.objects,
        isFunction: plain.functions,
        isBoolean: plain.booleans,
        isPresent: isPresent,
...
DefineAccessors(Techie.prototype, "CSS", function gttr(){
	return function(object, styleOptions){
		style(object, styleOptions); return this;
	};
